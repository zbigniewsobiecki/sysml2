...
static pcc_thunk_chunk_t *pcc_evaluate_rule_OccurrenceDefinitionPrefix(pcc_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_PerformActionDeclaration(pcc_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_DefinitionPrefix(pcc_context_t *ctx) {
    ...
    ctx->level++;
    {
        ...
        MARK_VAR_AS_USED
        const size_t n = chunk->thunks.len;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_BasicDefinitionPrefix, &chunk->thunks, NULL)) goto L0002;
        goto L0001;
    L0002:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_KW_ABSTRACT, &chunk->thunks, NULL)) goto L0003;
        goto L0001;
    L0003:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_KW_VARIATION, &chunk->thunks, NULL)) goto L0004;
        goto L0001;
    L0004:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_BasicDefinitionPrefix(pcc_context_t *ctx) {
    ...
    L0002:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_OccurrenceDefinitionPrefix, &chunk->thunks, NULL)) goto L0003;
        goto L0001;
    L0003:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_OccurrenceDefinitionPrefix(pcc_context_t *ctx) {
    pcc_thunk_chunk_t *const chunk = pcc_thunk_chunk__create(ctx);
    chunk->pos = ctx->cur;
    PCC_DEBUG(ctx->auxil, PCC_DBG_EVALUATE, "OccurrenceDefinitionPrefix", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->buffer.len - chunk->pos));
    ctx->level++;
    {
        MARK_VAR_AS_USED
        const size_t p = ctx->cur;
        MARK_VAR_AS_USED
        const size_t n = chunk->thunks.len;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_LifeclassPrefix, &chunk->thunks, NULL)) goto L0001;
        goto L0002;
    L0001:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
    ...
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_MATCH, "OccurrenceDefinitionPrefix", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    return chunk;
}
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_UsagePrefix(pcc_context_t *ctx) {
    ...
    ctx->level++;
    {
        ...
        MARK_VAR_AS_USED
        const size_t n = chunk->thunks.len;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_BasicUsagePrefix, &chunk->thunks, NULL)) goto L0002;
        goto L0001;
    L0002:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_BasicUsagePrefix(pcc_context_t *ctx) {
    ...
    ctx->level++;
    {
        ...
        MARK_VAR_AS_USED
        const size_t n = chunk->thunks.len;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_RefPrefix, &chunk->thunks, NULL)) goto L0001;
        goto L0002;
    L0001:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_RefPrefix(pcc_context_t *ctx) {
    ...
    L0004:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_KW_END, &chunk->thunks, NULL)) goto L0005;
        goto L0001;
    L0005:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_PerformActionUsage(pcc_context_t *ctx) {
    ...
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_PerformActionDeclaration, &chunk->thunks, NULL)) goto L0000;
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ActionBody, &chunk->thunks, NULL)) goto L0000;
    ctx->level--;
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_PerformActionDeclaration(pcc_context_t *ctx) {
    pcc_thunk_chunk_t *const chunk = pcc_thunk_chunk__create(ctx);
    chunk->pos = ctx->cur;
    PCC_DEBUG(ctx->auxil, PCC_DBG_EVALUATE, "PerformActionDeclaration", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->buffer.len - chunk->pos));
    ctx->level++;
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_KW_PERFORM, &chunk->thunks, NULL)) goto L0000;
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_QualifiedName, &chunk->thunks, NULL)) goto L0000;
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_MATCH, "PerformActionDeclaration", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    return chunk;
L0000:;
    ctx->level--;
    PCC_DEBUG(ctx->auxil, PCC_DBG_NOMATCH, "PerformActionDeclaration", ctx->level, chunk->pos, (ctx->buffer.buf + chunk->pos), (ctx->cur - chunk->pos));
    pcc_thunk_chunk__destroy(ctx, chunk);
    return NULL;
}
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_UsageElement(pcc_context_t *ctx) {
    ...
    L0002:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_EnumerationUsage, &chunk->thunks, NULL)) goto L0003;
        goto L0001;
    L0003:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_OccurrenceUsage, &chunk->thunks, NULL)) goto L0004;
        goto L0001;
    L0004:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ItemUsage, &chunk->thunks, NULL)) goto L0005;
        goto L0001;
    L0005:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_PartUsage, &chunk->thunks, NULL)) goto L0006;
        goto L0001;
    L0006:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ConnectionUsage, &chunk->thunks, NULL)) goto L0007;
        goto L0001;
    L0007:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_FlowUsage, &chunk->thunks, NULL)) goto L0008;
        goto L0001;
    L0008:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_InterfaceUsage, &chunk->thunks, NULL)) goto L0009;
        goto L0001;
    L0009:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_PortUsage, &chunk->thunks, NULL)) goto L0010;
        goto L0001;
    L0010:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_AllocationUsage, &chunk->thunks, NULL)) goto L0011;
        goto L0001;
    L0011:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ActionUsage, &chunk->thunks, NULL)) goto L0012;
        goto L0001;
    L0012:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_StateUsage, &chunk->thunks, NULL)) goto L0013;
        goto L0001;
    L0013:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ConstraintUsage, &chunk->thunks, NULL)) goto L0014;
        goto L0001;
    L0014:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_RequirementUsage, &chunk->thunks, NULL)) goto L0015;
        goto L0001;
    L0015:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ConcernUsage, &chunk->thunks, NULL)) goto L0016;
        goto L0001;
    L0016:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
    ...
    L0017:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_CaseUsage, &chunk->thunks, NULL)) goto L0018;
        goto L0001;
    L0018:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_AnalysisUsage, &chunk->thunks, NULL)) goto L0019;
        goto L0001;
    L0019:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_VerificationUsage, &chunk->thunks, NULL)) goto L0020;
        goto L0001;
    L0020:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_UseCaseUsage, &chunk->thunks, NULL)) goto L0021;
        goto L0001;
    L0021:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ViewUsage, &chunk->thunks, NULL)) goto L0022;
        goto L0001;
    L0022:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ViewpointUsage, &chunk->thunks, NULL)) goto L0023;
        goto L0001;
    L0023:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_RenderingUsage, &chunk->thunks, NULL)) goto L0024;
        goto L0001;
    L0024:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_UsageSpecialization(pcc_context_t *ctx) {
    ...
    L0003:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_Redefines, &chunk->thunks, NULL)) goto L0004;
        goto L0001;
    L0004:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_References, &chunk->thunks, NULL)) goto L0005;
        goto L0001;
    L0005:;
        ctx->cur = p;
        pcc_thunk_array__revert(ctx, &chunk->thunks, n);
